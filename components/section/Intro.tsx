...
const Intro = () => {
  ...
  return (
    <div className="bg-stone-200">
        <div className="max-w-screen-xl min-w-96 flex flex-col md:items-center mx-auto py-12 pb-16">
            <div className="grid grid-cols-2 gap-x-8 justify-between">
                <div className="flex flex-col gap-y-6">
                    <h2 className="text-3xl uppercase font-bold text-primary">{intro.title}</h2>
                    <p className="text-base font-semibold text-primary leading-7">{intro.description}</p>
                </div>
                {
                    image && (
